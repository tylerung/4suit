...
import {
  ...
  type Amenity, type GameType, type VenueType,
} from '../types'
...
export default function RankingsScreen() {
  const {
    revision, origin, originLabel, metro, setMetroId,
  ...
  const rows = useMemo(() => {
    void revision
    return rankVenues({ origin, radiusMi, type, games, amenities, minReviews, sort })
  }, [revision, origin, radiusMi, type, games, amenities, minReviews, sort])
