...
const USER_SEEDS: UserSeed[] = [
  { id: 'u-you', username: '4suiter', displayName: 'You', bio: 'New here. Grinding $1/$3 and taking notes on every room I sit in.', avatarTone: 'blue', roles: ['recreational', 'cash-player'], homeVenueId: 'v-aria', location: 'Las Vegas, NV', isPrivate: false, verified: false, joinedDaysAgo: 12 },
