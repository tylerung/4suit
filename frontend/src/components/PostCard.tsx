      ...
      <div className="post-main">
                ...
                <div className="post-menu card">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      // Leave the screen only once the delete has landed; a
                      // failed one would otherwise pop the user back to a feed
                      // where the post is still sitting.
                      void deletePost(post.id).then(() => { if (detail) navigate(-1) })
                    }}
                  >
                    Delete post
                  </button>
          ...
          <div className="post-edit" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="row" style={{ justifyContent: 'flex-end', marginTop: 8 }}>
              ...
              <button
                ...
                disabled={!draft.trim()}
                onClick={() => { void updatePost(post.id, draft).then(() => setEditing(false)) }}
              >
                Save
              </button>
            </div>
        ...
        <footer className="post-actions" onClick={(e) => e.stopPropagation()}>
          <button
            ...
            onClick={() => { if (currentUser) void toggleLike(post.id) }}
